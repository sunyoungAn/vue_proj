<template>
            ...
            <div class="mb-5">
                ...
                <div class="px-5">
                    <div class="row mb-3">
                        ...
                        <div class="col-4">
                            <input type="text" class="form-control" placeholder="판매입찰번호">
                        </div>
                        <div class="col-2 py-2">
                            상품번호
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-4">
                            <input type="text" class="form-control" placeholder="판매자번호">
                        </div>
                        <div class="col-2 py-2">
                            보관상태
                        </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>1</td>
                            <td>11</td> <!-- TODO 상품상세페이지로 이동하게 할까?-->
                            <td>250</td>
                            <td>140,000</td>
                            <td>35</td>
                            <td>
                                <select class="form-select brand_select" id="inputGroupSelect01">
                                    <option selected>검수중</option>
                                    <option value="1">입찰중</option>
                                    <option value="2">입찰중</option>
                                </select>
                            </td>
                            <td>2023/04/07</td>
                            <td>
                                <button type="button" class="btn btn-outline-success btn-sm" @click="openModal()">결제정보</button>
                            </td>
                        </tr>
                        <tr>
                            <td><input class="form-check-input" type="checkbox" value=""></td>
                            ...
                            <td>2023/04/07</td>
                            <td>
                                <button type="button" class="btn btn-outline-success btn-sm">결제정보</button>
                            </td>
                        </tr>
                        <tr>
                            <td><input class="form-check-input" type="checkbox" value=""></td>
    ...
    <!-- 모달영역 -->
    <admin-payment-modal v-if="state.isModalShow"></admin-payment-modal>
